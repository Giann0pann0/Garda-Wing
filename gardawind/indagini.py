"""Gli STRUMENTI D'INDAGINE: quelli con cui si capisce, non quelli che pubblicano.

Stavano in __main__.py, che e' il file da cui si entra nel programma. Erano 15
funzioni per 1.738 righe su 2.433, cioe' il 71%: il posto dove si va a guardare
quando qualcosa non torna era diventato il piu' grande del progetto, e per tre
quarti non parlava del prodotto.

Il prodotto ha tre comandi: --ci (il giro lungo), --live-json (il giro veloce),
--export (il sito). Tutti gli altri - le distribuzioni, le direzioni, le
raffiche, gli audit, le validazioni, i censimenti - servono a capire il lago e a
scrivere i documenti in docs/, e sono altrettanto importanti: solo, non sono la
stessa cosa, e tenerli insieme faceva sembrare complicato un programma che nel
cammino che arriva all'utente e' corto.

Nessun comando e' cambiato: __main__ dichiara gli stessi argomenti di prima e
chiama queste funzioni. Gli script in mac/ continuano a funzionare identici.
"""
